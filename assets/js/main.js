...
function setupExternalLinks() {
    const config = window.yassiConfig || {};
    if (config.openExternalLinksInNewTab === false) return;

    const host = location.hostname;
    document.querySelectorAll('.post-content a[href^="http"], .cover-intro a[href^="http"]').forEach(function (a) {
